...
// CSV
let csvfile = "starting_pitcher_qualified_seasons_1969_to_2018_standard.csv";
d3.csv(csvfile, function(d) { 
  let k_bb = (d.SO - d.BB) / d.TBF;
  return {
    season: +d.Season,
    name:  d.Name,
    team:  d.Team,
  ...
  // Calculate median K-BB% for each season
  ...
  x.domain([xMin, xMax]);
  y.domain(d3.extent(dataset, d => d.k_bb)).nice();
  ...
  g.append("g")
    ...
    .call(d3.axisLeft(y).tickFormat(d3.format("0.1%")))
    .append("text")
  ...
  g.append("g")
    ...
    .append("circle")
      ...
      .on("mouseover", function(d) {
        ...
        circle.attr("r", 7).attr("fill", "#17EBF0").attr("fill-opacity", 0.85);
        // Tooltips
        var xPosition = x(d.season) + 110;
        var yPosition = y(d.k_bb) + 100;
        ...
        tooltip.select("#K_BB").text(d3.format(".1%")(d.k_bb));
        tooltip.select("#era").text(d3.format("0.3r")(d.era));
        

        d3.select("#tooltip").classed("hidden", false);
      })
      .on("mouseout", function () {
        d3.select(this).attr("fill", "#ABBABA").attr("r", 4);
  ...
  g.selectAll("circle.median")
    ...
    .append("circle")
      ...
      .on("mouseover", function(d) {
        ...
        tooltip.select("#tooltip-median span#K_BB").text(d3.format(".3r")(d.k_bb));
  ...
  let source = {
    ...
    "size": 17,
    "link": "https://www.fangraphs.com/leaders.aspx?pos=all&stats=sta&lg=all&qual=y&type=1&season=2018&month=0&season1=1969&ind=1&team=0&rost=0&age=0&filter=&players=0&sort=10,d",
    "font_family": "Calibri",
    "color": "50AE26"
  }
